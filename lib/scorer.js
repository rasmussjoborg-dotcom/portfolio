...
1. Remote within Europe/EMEA timezone (CET ±3 hours) = tier 1 — strongly preferred
2. Stockholm, Sweden (on-site or hybrid) = tier 2 — acceptable
3. Other European locations ONLY if relocation support is explicitly mentioned = tier 3
4. Remote jobs requiring US timezone overlap or based in Americas = tier 0 (REJECT — too much time difference from Stockholm)
5. On-site in non-Stockholm/non-European locations without relocation support = tier 0 (poor match)

IMPORTANT: The candidate lives in Stockholm, Sweden (CET timezone). Any remote job that is US-only, Americas-only, or requires significant US timezone overlap should score very low (tier 0, heavy penalty).
...
- Location fit: up to 25 points (remote Europe=25, Stockholm=20, relocation=10, US-only/other=0)
