                    ...
                    responseSchema: {
                        ...
                        properties: {
                            ...
                            sector: {
                                type: "string",
                                description:
                                    "Company industry sector, e.g. Fintech, SaaS, E-commerce, Automotive, HR-tech, Gaming, Healthcare, Retail, Agency, Consulting",
                            },
                            companyDescription: {
                                type: "string",
                                description:
                                    "What the company does in 1-2 short sentences max. Be concise.",
                            },
                        },
                        required: ["score", "reasoning", "locationTier", "sector", "companyDescription"],
                    },
                },
            }),
        });
...
1. Remote within Europe/EMEA = tier 1 — strongly preferred (CET ±3 hours timezone)
2. Stockholm, Sweden (hybrid or remote) = tier 2 — acceptable, candidate lives here
3. Dubai/UAE or Singapore — ONLY acceptable if a relocation package is explicitly mentioned = tier 3
4. Any other location outside Europe/Dubai/Singapore = tier 0 (REJECT)
5. Remote jobs requiring US/Americas timezone overlap = tier 0 (REJECT — too much time difference)
6. On-site roles outside Stockholm without relocation support = tier 0 (REJECT)

IMPORTANT: The candidate lives in Stockholm, Sweden (CET timezone). Remote-first is the priority. For Dubai and Singapore, the role MUST include relocation support — if it does not explicitly mention relocation, score it as tier 0.
...
- Location fit: up to 25 points (remote Europe=25, Stockholm hybrid/remote=20, Dubai/Singapore with relocation=15, everything else=0)
- Company/industry fit: up to 15 points
- Penalize heavily if the role is junior-level or unrelated to design/product
- Penalize heavily if the job is US-only remote or requires Americas timezone
- Dubai/Singapore jobs without relocation package = heavy penalty
